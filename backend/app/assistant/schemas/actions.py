...
AssistantActionType = Literal["prepare_clickup_us", "save_time_entry", "reply_freshservice_ticket", "resolve_freshservice_ticket", "request_info_freshservice_ticket", "send_ticket_to_backlog", "link_existing_clickup_task"]
